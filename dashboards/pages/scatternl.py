...
df = pd.read_csv('Scatter_Loess_data_nl.csv',encoding = "ISO-8859-1")
...
#Make layout
fig_dict["layout"]["title"] = {'text':"Ontwikkeling en internationale studenten:",
                               'font':{'size':28,'family':'sans-serif','color':'black'}}
fig_dict["layout"]["xaxis"] = {"range": [0.25,1], #sets the limits of the axes
                               "title": "Ontwikkelingsniveau van landen",#Axis title
...
fig_dict["layout"]["yaxis"] = {"range":[0,8.5], #range. Note that Australia now falls outside of it
                               'title':'Internationale studenten als % van het aantal 15-24 jarigen',
...
data_dict_scatter_out = {
    ...
    "name": "Emigratie", #the name that appears in the legend and hovertext
    'text': list(dfgo['NAT']), #text that appears in the hovertext
    'hovertemplate':"<b>%{text}</b><br>" +
                    "Internationale Studenten: %{y:.0f}%<br>" +
...
data_dict_line_out = {
    ...
    'line':{
        'color':'#316395'},
    "name": "Gemiddelde emigratie",
    'hovertemplate':"<b>Loesscurve</b><br>"
                        "Internationale Studenten: %{y:.0f}%<br>"
                        "Human Development Index: %{x:.3f}"
    }
#line inbound
...
slider_dict = {
    ...
    "currentvalue": { #dict for a label for the slider
        ...
        "prefix": "Jaar:", #prefix of the label
